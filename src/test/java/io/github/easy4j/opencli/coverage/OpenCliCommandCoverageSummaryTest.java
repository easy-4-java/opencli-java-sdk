...
class OpenCliCommandCoverageSummaryTest {
    ...
    static final int MANIFEST_ADAPTER_COMMANDS = 1277;
    ...
    /** 合计需覆盖命令数。 */
    static final int TOTAL_COMMANDS = 1349;
    ...
    void totalCoverageBudget() {
        assertEquals(1349, MANIFEST_ADAPTER_COMMANDS + META_COMMANDS + BROWSER_COMMANDS);
    }
}
