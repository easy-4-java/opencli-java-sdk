...
public final class OpenCliAdapterIds {
    ...
    public static final String OEIS = "oeis";
    public static final String ONES = "ones";
    public static final String OPENALEX = "openalex";
    public static final String OPENFDA = "openfda";
    public static final String OPENREVIEW = "openreview";
    public static final String OSV = "osv";
    public static final String PACKAGIST = "packagist";
    public static final String PAPERREVIEW = "paperreview";
    public static final String PIXIV = "pixiv";
    public static final String POWERCHINA = "powerchina";
    ...
    public static final String XIAOE = "xiaoe";
    ...
    public static final String ZLIBRARY = "zlibrary";
    public static final String ZSXQ = "zsxq";
